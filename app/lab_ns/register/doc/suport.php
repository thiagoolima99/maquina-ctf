...
<div class="container">
    <div class="row border mt-3 border-success border-top-0 border-left-0 border-right-0">
        <h5 class="font-weight-bold text-secondary  mt-1 mr-2 mb-2">Suporte técnico <i class="fas fa-fisle"></i></h5> 
...
<div class="container">
    <form method="POST">
        ...
        <div class="form-row mt-5">
            ...
            <h4>Olá <b>administrador</b>, o sistema possui suporte para cadastro e edição de componentes selecionados.</h4>
            <h5>Caso necessite realizar consultas ou alterações além do nível permitido no sistema, entre em contato: 0800 0732222</h5>
